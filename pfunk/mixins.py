...
from valley.validators import (RequiredValidator, StringValidator,
                               ...
                               ListValidator, ForeignValidator,
                               ForeignListValidator, MultiValidator, ChoiceValidator as CV)


class ChoiceValidator(CV):
